          ...
          {mode === 'Event Results' && events && events.length > 0 && (() => {
            ...
            return (
              <DisplayCompResults
                ...
                activeRoundId={currentEvent.activeRoundId}
                roundScores={currentEvent.roundScores || {}}
                roundFinalized={currentEvent.roundFinalized || {}}
                roundReleasedDances={currentEvent.roundReleasedDances || {}}
                isAnimationOn={true}
                colorBG={colorBG}
                textColor={textColor}
              />
