...
import { Event, Couple, Placement, Judge, FinalResult } from '@/types/types2';
...
const FinalResults: React.FC<FinalResultsProps> = ({ event, onBackToDashboard }) => {
  ...
  return (
    <div className="min-h-screen w-screen bg-slate-900 p-4 sm:p-12 flex flex-col items-center absolute top-0 left-0">
